...
| **tailor-review** | hygiene + meta | Two-pass framework review (hygiene + strategic). Hygiene applies mechanical reversible repairs. Strategic surfaces ranked framework-improvement suggestions, tagged `superagent` (handed to Coder) or `_custom` (Tailor implements). |
