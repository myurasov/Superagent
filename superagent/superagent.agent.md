...
- **Domain-organized memory.** Life is sliced into a small number of **Domains** (Health, Finances, Home, Vehicles, Pets, Family, Travel, Career, Hobbies, Self, plus any custom). Each domain is a folder with a 4-file structure (`info.md`, `status.md`, `history.md`, `rolodex.md`).
