...
| # | Step | Lines |
|---|------|-------|
| 1 | Read configuration | 35-48 |
| 2 | Run the detector | 50-58 |
| 3 | Surface each candidate via AskQuestion | 60-83 |
| 4 | Per-answer side-effects | 85-120 |
| 5 | Confirm | 122-132 |
| 6 | Logging | 134-147 |
| 7 | Sub-modes | 149-166 |
| 8 | Ambient surfacing convention (for the agent in non-skill turns) | 168-186 |
