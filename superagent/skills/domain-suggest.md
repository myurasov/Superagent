...
| # | Step | Lines |
|---|------|-------|
| 1 | Read configuration | 36-49 |
| 2 | Run the detector | 51-59 |
| 3 | Surface each candidate via AskQuestion | 61-84 |
| 4 | Per-answer side-effects | 86-121 |
| 5 | Confirm | 123-133 |
| 6 | Logging | 135-148 |
| 7 | Sub-modes | 150-167 |
| 8 | Ambient surfacing convention (for the agent in non-skill turns) | 169-187 |
