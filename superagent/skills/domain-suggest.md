...
| # | Step | Lines |
|---|------|-------|
| 1 | Read configuration | 55-69 |
| 2 | Run the detector | 70-79 |
| 3 | Surface each candidate via AskQuestion | 80-104 |
| 4 | Per-answer side-effects | 105-141 |
| 5 | Confirm | 142-153 |
| 6 | Logging | 154-169 |
| 7 | Sub-modes | 170-188 |
| 8 | Ambient surfacing convention (for the agent in non-skill turns) | 189-208 |
