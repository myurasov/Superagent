...
| # | Step | Lines |
|---|------|-------|
| 1 | Mode 1: render-all (default) | 30-48 |
| 2 | Mode 2: render one workbook | 50-59 |
| 3 | Mode 3: status | 61-69 |
| 4 | Mode 4: enable / disable opt-in workbooks | 71-81 |
| 5 | Mode 5: dry-run / check | 83-92 |
| 6 | Privacy scan | 94-110 |
| 7 | History window | 112-118 |
| 8 | Where workbooks live | 120-132 |
| 9 | Logging | 134-145 |
