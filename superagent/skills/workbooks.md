...
| # | Step | Lines |
|---|------|-------|
| 1 | Mode 1: render-all (default) | 31-49 |
| 2 | Mode 2: render one workbook | 51-60 |
| 3 | Mode 3: status | 62-70 |
| 4 | Mode 4: enable / disable opt-in workbooks | 72-82 |
| 5 | Mode 5: dry-run / check | 84-93 |
| 6 | Privacy scan | 95-111 |
| 7 | History window | 113-119 |
| 8 | Where workbooks live | 121-133 |
| 9 | Logging | 135-146 |
