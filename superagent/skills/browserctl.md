...
| # | Step | Lines |
|---|------|-------|
| 1 | Step 0 — Why this exists | 24-40 |
| 2 | Step 1 — Profiles: per-project, clean, ephemeral on demand | 42-66 |
| 3 | Step 2 — Command reference | 68-98 |
| 4 | Step 3 — Typical flows | 100-111 |
| 5 | Step 4 — Scripting anything else: attach() | 113-135 |
| 6 | Step 5 — Per-web-app skills: `browserctl-<app>` | 137-154 |
| 7 | Step 6 — Hard rules and known constraints | 156-172 |
