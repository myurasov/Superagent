...
| # | Step | Lines |
|---|------|-------|
| 1 | Step 0 — Why this exists | 26-42 |
| 2 | Step 1 — Profiles: per-project, clean, ephemeral on demand | 44-68 |
| 3 | Step 2 — Command reference | 70-101 |
| 4 | Step 3 — Typical flows | 103-114 |
| 5 | Step 4 — Scripting anything else: attach() | 116-138 |
| 6 | Step 5 — Per-web-app skills: `browserctl-<app>` | 140-157 |
| 7 | Step 6 — Hard rules and known constraints | 159-175 |
...
machine-local and disposable — never inside the repo (this repo is iCloud-synced). This is the
one sanctioned write location outside the project root (see
`rules/development-tooling.md` § "browserctl state").
