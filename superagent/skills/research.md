...
| # | Step | Lines |
|---|------|-------|
| 1 | Parse the query | 29-34 |
| 2 | Search local first | 36-46 |
| 3 | Search MCPs (parallel where possible) | 48-58 |
| 4 | Web search (if available) | 60-62 |
| 5 | Synthesize | 64-67 |
| 6 | Research Brief: <topic> | 69-89 |
| 6 | Offer next steps | 91-97 |
| 7 | Logging | 99-106 |
