...
| # | Step | Lines |
|---|------|-------|
| 1 | Parse the query | 28-33 |
| 2 | Search local first | 35-45 |
| 3 | Search MCPs (parallel where possible) | 47-57 |
| 4 | Web search (if available) | 59-61 |
| 5 | Synthesize | 63-66 |
| 6 | Research Brief: <topic> | 68-88 |
| 6 | Offer next steps | 90-96 |
| 7 | Logging | 98-105 |
